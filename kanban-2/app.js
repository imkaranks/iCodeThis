(function () {
  ...
  function addCard($content) {
    ...
    // Todo: add edit functionality to new ones
    // const $editBtn = document.createElement('button');
    // $editBtn.className = "edit-btn text-[#B4B6C1] px-4 mt-2";
    // $editBtn.setAttribute('title', 'edit');
    // $editBtn.innerHTML = '<i class="fa-solid fa-ellipsis" aria-hidden="true"></i>';
    // $editBtn.onclick = (e) => editCard(e);
    // Todo: add edit functionality to new ones
